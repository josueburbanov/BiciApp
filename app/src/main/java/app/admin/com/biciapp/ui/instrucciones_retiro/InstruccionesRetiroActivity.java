package app.admin.com.biciapp.ui.instrucciones_retiro;
...
import app.admin.com.biciapp.ui.procesando_retiro.ProcesandoRetiroActivity;
            ...
            public void onChanged(@Nullable Candado candado) {
                if (candado == null) {
                    ...
                    if (candado.isAbierto()) {
                        viewModel.getCandado().removeObserver(this);
                        ...
                        intent.putExtra(InstruccionesDevolucionActivity.CANDADO_VIEW, candadoView);
